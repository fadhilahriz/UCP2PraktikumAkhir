            ...
            <div class="card">
                <div class="card">
                    ...
                    <div class="card-body fw-bold">
                        <form name="login" method="post" action="login.php" onsubmit="return validation()">
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-brand" value="SIMPAN">Login</button>
                            <p>Don't have an account? <a href="regist.php">Signup</a></p>
                        </form>
                    </div>
                </div>
            </div>
